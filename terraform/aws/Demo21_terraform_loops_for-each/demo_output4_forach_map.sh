...
Terraform will perform the following actions:
  ...
  # aws_instance.server["app"] will be created
  + resource "aws_instance" "server" {
      + ami                          = "00b8d9cb8a7161e41"
...
aws_iam_user.user["raju14@bharathkumaraju.com"]: Refreshing state... [id=raju14@bharathkumaraju.com]
aws_iam_user.user["raju13@bharathkumaraju.com"]: Refreshing state... [id=raju13@bharathkumaraju.com]
aws_instance.server["web"]: Creating...
aws_instance.server["app"]: Creating...
aws_instance.server["app"]: Still creating... [10s elapsed]
aws_instance.server["web"]: Still creating... [10s elapsed]
aws_instance.server["web"]: Creation complete after 16s [id=i-059c691ffefd0fc84]
aws_instance.server["app"]: Still creating... [20s elapsed]
aws_instance.server["app"]: Creation complete after 24s [id=i-06cdf34a94614757d]
