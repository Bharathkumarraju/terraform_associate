...
Terraform will perform the following actions:
  ...
  # aws_instance.bharath_server["Dev"] will be created
  ...
  # aws_instance.bharath_server["Prod"] will be created
  + resource "aws_instance" "bharath_server" {
      + ami                          = "ami-00b8d9cb8a7161e41"
      + arn                          = (known after apply)
      + associate_public_ip_address  = (known after apply)
  ...
  # aws_instance.bharath_server["Staging"] will be created
  + resource "aws_instance" "bharath_server" {
      + ami                          = "ami-00b8d9cb8a7161e41"
      + arn                          = (known after apply)
      + associate_public_ip_address  = (known after apply)
...
aws_iam_user.user["raju16@bharathkumaraju.com"]: Refreshing state... [id=raju16@bharathkumaraju.com]
aws_iam_user.user["raju18@bharathkumaraju.com"]: Refreshing state... [id=raju18@bharathkumaraju.com]
aws_instance.bharath_server["Dev"]: Creating...
aws_instance.bharath_server["Staging"]: Creating...
aws_instance.bharath_server["Prod"]: Creating...
aws_instance.bharath_server["Prod"]: Still creating... [10s elapsed]
aws_instance.bharath_server["Dev"]: Still creating... [10s elapsed]
aws_instance.bharath_server["Staging"]: Still creating... [10s elapsed]
aws_instance.bharath_server["Dev"]: Creation complete after 12s [id=i-0f418d45f6240d45c]
aws_instance.bharath_server["Staging"]: Creation complete after 12s [id=i-092182e75ea12f82d]
aws_instance.bharath_server["Prod"]: Creation complete after 12s [id=i-0dfb498602d2f11bb]
